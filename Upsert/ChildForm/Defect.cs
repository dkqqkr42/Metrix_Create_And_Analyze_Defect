...
namespace Upsert
{
    public partial class Defect : MetroForm, IChildForm
    {
        ...
        public string StoredProcedureName() => "DEFECT_UPSERT";
        ...
        public bool DeleteItem()
        {
            ...
            try
            {
                ...
                OracleCommand cmd = new OracleCommand
                {
                    CommandType = CommandType.Text,
                    Connection = connection,
                    CommandText = "update tbl_defect set DEL_FLAG = 'D', update_date = SYSDATE where trim(WC_CODE) = :DeleteVal"
                };
